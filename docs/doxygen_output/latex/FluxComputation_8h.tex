\doxysection{code/include/\+Flux\+Computation.h File Reference}
\hypertarget{FluxComputation_8h}{}\label{FluxComputation_8h}\index{code/include/FluxComputation.h@{code/include/FluxComputation.h}}
...
\item 
class \mbox{\hyperlink{classflux}{flux}}
\begin{DoxyCompactList}\small\item\em Computes the fluxes for the Shallow Water Equations in a collocated grid. \end{DoxyCompactList}\item 
class \mbox{\hyperlink{classflux__staggered}{flux\+\_\+staggered}}
\begin{DoxyCompactList}\small\item\em Computes the fluxes for the Shallow Water Equations in a staggered grid. \end{DoxyCompactList}\end{DoxyCompactItemize}
\doxysubsubsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \mbox{\hyperlink{FluxComputation_8h_a047d256037d27435f4f1218b38685b9b}{Recontruction\+\_\+\+Order1}} (float \texorpdfstring{$\ast$}{*}Hn, float \texorpdfstring{$\ast$}{*}Hl, float \texorpdfstring{$\ast$}{*}Hr, unsigned int N)
...
void \mbox{\hyperlink{FluxComputation_8h_a0b1b58ffc138adc95d6b8573e56daf77}{Recontruction\+\_\+\+Order2}} (float \texorpdfstring{$\ast$}{*}Hn, float \texorpdfstring{$\ast$}{*}Hl, float \texorpdfstring{$\ast$}{*}Hr, unsigned int N)
...
void \mbox{\hyperlink{FluxComputation_8h_a885eac6dccfcc8b73fdb27b433efa00b}{Recontruction\+\_\+\+Order3}} (float \texorpdfstring{$\ast$}{*}Hn, float \texorpdfstring{$\ast$}{*}Hl, float \texorpdfstring{$\ast$}{*}Hr, unsigned int N)
...
void \mbox{\hyperlink{FluxComputation_8h_ae61ccf497bda712978ba2fac7e211d13}{Recontruction\+\_\+\+Order5}} (float \texorpdfstring{$\ast$}{*}Hn, float \texorpdfstring{$\ast$}{*}Hl, float \texorpdfstring{$\ast$}{*}Hr, unsigned int N)
...
float \mbox{\hyperlink{FluxComputation_8h_a14240127a8376ac6eff63eaca802f766}{minmod}} (float a, float b, float c)
\begin{DoxyCompactList}\small\item\em Computes the Min\+Mod limiter function. \end{DoxyCompactList}\item 
float \mbox{\hyperlink{FluxComputation_8h_ab5374d849e36ba16e42428a4674e16f3}{upwind}} (float V, float Q1, float Q2)
\begin{DoxyCompactList}\small\item\em Upwind function for 1D advection problems. \end{DoxyCompactList}\item 
float \mbox{\hyperlink{FluxComputation_8h_a03e356ed6b569840b09933d9538d1634}{upwind}} (float V, float Q1, float Q2, float Q3, float Q4)
...
void \mbox{\hyperlink{FluxComputation_8h_ade1f7f95f720e6c73d063f64fe10f87e}{Flux\+\_\+\+Central\+Upwind}} (float \texorpdfstring{$\ast$}{*}Hl, float \texorpdfstring{$\ast$}{*}Hr, float \texorpdfstring{$\ast$}{*}Ql, float \texorpdfstring{$\ast$}{*}Qr, float \texorpdfstring{$\ast$}{*}FluxH, float \texorpdfstring{$\ast$}{*}FluxQ, unsigned int N)
\begin{DoxyCompactList}\small\item\em Central-\/upwind scheme for numerical flux computation. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{FluxComputation_8h_a1c4a609a92dc39c7441057fcf4a70e2f}{Flux\+\_\+\+HLL}} (float \texorpdfstring{$\ast$}{*}Hl, float \texorpdfstring{$\ast$}{*}Hr, float \texorpdfstring{$\ast$}{*}Ql, float \texorpdfstring{$\ast$}{*}Qr, float \texorpdfstring{$\ast$}{*}FluxH, float \texorpdfstring{$\ast$}{*}FluxQ, unsigned int N)
...
void \mbox{\hyperlink{FluxComputation_8h_a06eca82ea44bc6e1f759e96835038d81}{Flux\+\_\+\+HLLC}} (float \texorpdfstring{$\ast$}{*}Hl, float \texorpdfstring{$\ast$}{*}Hr, float \texorpdfstring{$\ast$}{*}Ql, float \texorpdfstring{$\ast$}{*}Qr, float \texorpdfstring{$\ast$}{*}FluxH, float \texorpdfstring{$\ast$}{*}FluxQ, unsigned int N)
...
\Hypertarget{FluxComputation_8h_ade1f7f95f720e6c73d063f64fe10f87e}\index{FluxComputation.h@{FluxComputation.h}!Flux\_CentralUpwind@{Flux\_CentralUpwind}}
\index{Flux\_CentralUpwind@{Flux\_CentralUpwind}!FluxComputation.h@{FluxComputation.h}}
\doxysubsubsection{\texorpdfstring{Flux\_CentralUpwind()}{Flux\_CentralUpwind()}}
{\footnotesize\ttfamily \label{FluxComputation_8h_ade1f7f95f720e6c73d063f64fe10f87e} 
...
Reference\+: Kurganov, A., \& Petrova, G. (2007). \Hypertarget{FluxComputation_8h_a1c4a609a92dc39c7441057fcf4a70e2f}\index{FluxComputation.h@{FluxComputation.h}!Flux\_HLL@{Flux\_HLL}}
\index{Flux\_HLL@{Flux\_HLL}!FluxComputation.h@{FluxComputation.h}}
\doxysubsubsection{\texorpdfstring{Flux\_HLL()}{Flux\_HLL()}}
{\footnotesize\ttfamily \label{FluxComputation_8h_a1c4a609a92dc39c7441057fcf4a70e2f} 
...
\hline
\end{DoxyParams}
Reference\+: Harten, A., Lax, P. D., \& van Leer, B. (1983). \Hypertarget{FluxComputation_8h_a06eca82ea44bc6e1f759e96835038d81}\index{FluxComputation.h@{FluxComputation.h}!Flux\_HLLC@{Flux\_HLLC}}
\index{Flux\_HLLC@{Flux\_HLLC}!FluxComputation.h@{FluxComputation.h}}
\doxysubsubsection{\texorpdfstring{Flux\_HLLC()}{Flux\_HLLC()}}
{\footnotesize\ttfamily \label{FluxComputation_8h_a06eca82ea44bc6e1f759e96835038d81} 
...
\hline
\end{DoxyParams}
Reference\+: Toro, 2001. "{}\+Shock-\/capturing methods for free-\/surface shallow flows."{} \Hypertarget{FluxComputation_8h_a14240127a8376ac6eff63eaca802f766}\index{FluxComputation.h@{FluxComputation.h}!minmod@{minmod}}
\index{minmod@{minmod}!FluxComputation.h@{FluxComputation.h}}
\doxysubsubsection{\texorpdfstring{minmod()}{minmod()}}
{\footnotesize\ttfamily \label{FluxComputation_8h_a14240127a8376ac6eff63eaca802f766} 
...
Reference\+: Kim and Kim (2005) \Hypertarget{FluxComputation_8h_a047d256037d27435f4f1218b38685b9b}\index{FluxComputation.h@{FluxComputation.h}!Recontruction\_Order1@{Recontruction\_Order1}}
\index{Recontruction\_Order1@{Recontruction\_Order1}!FluxComputation.h@{FluxComputation.h}}
\doxysubsubsection{\texorpdfstring{Recontruction\_Order1()}{Recontruction\_Order1()}}
{\footnotesize\ttfamily \label{FluxComputation_8h_a047d256037d27435f4f1218b38685b9b} 
...
\end{DoxyWarning}
\Hypertarget{FluxComputation_8h_a0b1b58ffc138adc95d6b8573e56daf77}\index{FluxComputation.h@{FluxComputation.h}!Recontruction\_Order2@{Recontruction\_Order2}}
\index{Recontruction\_Order2@{Recontruction\_Order2}!FluxComputation.h@{FluxComputation.h}}
\doxysubsubsection{\texorpdfstring{Recontruction\_Order2()}{Recontruction\_Order2()}}
{\footnotesize\ttfamily \label{FluxComputation_8h_a0b1b58ffc138adc95d6b8573e56daf77} 
...
\end{DoxyWarning}
\Hypertarget{FluxComputation_8h_a885eac6dccfcc8b73fdb27b433efa00b}\index{FluxComputation.h@{FluxComputation.h}!Recontruction\_Order3@{Recontruction\_Order3}}
\index{Recontruction\_Order3@{Recontruction\_Order3}!FluxComputation.h@{FluxComputation.h}}
\doxysubsubsection{\texorpdfstring{Recontruction\_Order3()}{Recontruction\_Order3()}}
{\footnotesize\ttfamily \label{FluxComputation_8h_a885eac6dccfcc8b73fdb27b433efa00b} 
...
Ensure {\ttfamily Hl} and {\ttfamily Hr} arrays have at least {\ttfamily N-\/1} elements to avoid out-\/of-\/bounds errors. 
\end{DoxyWarning}
\Hypertarget{FluxComputation_8h_ae61ccf497bda712978ba2fac7e211d13}\index{FluxComputation.h@{FluxComputation.h}!Recontruction\_Order5@{Recontruction\_Order5}}
\index{Recontruction\_Order5@{Recontruction\_Order5}!FluxComputation.h@{FluxComputation.h}}
\doxysubsubsection{\texorpdfstring{Recontruction\_Order5()}{Recontruction\_Order5()}}
{\footnotesize\ttfamily \label{FluxComputation_8h_ae61ccf497bda712978ba2fac7e211d13} 
...
Ensure {\ttfamily Hl} and {\ttfamily Hr} arrays have at least {\ttfamily N-\/1} elements to avoid out-\/of-\/bounds errors.
\end{DoxyWarning}
Refrence\+: Kim and Kim (2005) \Hypertarget{FluxComputation_8h_ab5374d849e36ba16e42428a4674e16f3}\index{FluxComputation.h@{FluxComputation.h}!upwind@{upwind}}
\index{upwind@{upwind}!FluxComputation.h@{FluxComputation.h}}
\doxysubsubsection{\texorpdfstring{upwind()}{upwind()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily \label{FluxComputation_8h_ab5374d849e36ba16e42428a4674e16f3} 
...
\end{DoxyReturn}
\Hypertarget{FluxComputation_8h_a03e356ed6b569840b09933d9538d1634}\index{FluxComputation.h@{FluxComputation.h}!upwind@{upwind}}
\index{upwind@{upwind}!FluxComputation.h@{FluxComputation.h}}
\doxysubsubsection{\texorpdfstring{upwind()}{upwind()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \label{FluxComputation_8h_a03e356ed6b569840b09933d9538d1634} 
